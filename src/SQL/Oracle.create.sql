...
ALTER TABLE "Посылка"
	ADD CONSTRAINT "Посылка_FКлюч_0" FOREIGN KEY ("Ключ") REFERENCES "Ключ" ("primaryKey");

CREATE INDEX "Посылка_IКлюч" on "Посылка" ("Ключ");
