...
namespace IIS.Novyjj_postamat
{
    ...
    public class Ячейка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Novyjj_postamat.Постамат fПостамат;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Novyjj_postamat.Постамат.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Постамат"})]
        public virtual IIS.Novyjj_postamat.Постамат Постамат
        {
            get
            {
                ...
                IIS.Novyjj_postamat.Постамат result = this.fПостамат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЯчейкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЯчейкаE", typeof(IIS.Novyjj_postamat.Ячейка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЯчейка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Novyjj_postamat.DetailArrayOfЯчейка members)

        // *** End programmer edit section *** (IIS.Novyjj_postamat.DetailArrayOfЯчейка members)
        ...
        /// </summary>
        public DetailArrayOfЯчейка(IIS.Novyjj_postamat.Постамат fПостамат) : 
                base(typeof(Ячейка), ((ICSSoft.STORMNET.DataObject)(fПостамат)))
        {
        }
        
        public IIS.Novyjj_postamat.Ячейка this[int index]
        {
            get
            {
                return ((IIS.Novyjj_postamat.Ячейка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Novyjj_postamat.Ячейка dataobject)
        {
