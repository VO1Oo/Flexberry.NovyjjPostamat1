...
namespace IIS.Novyjj_postamat
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Novyjj_postamat.Статусы fСтатус;
        
        private int fНомер;
        
        private string fАдрес;
        
        private IIS.Novyjj_postamat.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Novyjj_postamat.DetailArrayOfЯчейка fЯчейка;
        ...
        public virtual IIS.Novyjj_postamat.Статусы Статус
        {
            get
            {
                ...
                IIS.Novyjj_postamat.Статусы result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        [NotNull()]
        public virtual IIS.Novyjj_postamat.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Novyjj_postamat.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public virtual IIS.Novyjj_postamat.DetailArrayOfЯчейка Ячейка
        {
            get
            {
                ...
                {
                    this.fЯчейка = new IIS.Novyjj_postamat.DetailArrayOfЯчейка(this);
                }
                IIS.Novyjj_postamat.DetailArrayOfЯчейка result = this.fЯчейка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Novyjj_postamat.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Novyjj_postamat.Постамат));
                }
            }
        }
    }
