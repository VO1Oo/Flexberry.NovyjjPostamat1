...
namespace IIS.Novyjj_postamat
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Novyjj_postamat.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.Novyjj_postamat.Пользователь fПользователь;
        ...
        public virtual IIS.Novyjj_postamat.Оплата Оплата
        {
            get
            {
                ...
                IIS.Novyjj_postamat.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Novyjj_postamat.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Novyjj_postamat.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.Novyjj_postamat.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.Novyjj_postamat.Транзакция));
                }
            }
        }
    }
